...
import findRoute, {
  getUrlQuery,
} from '/Users/chenzilong/workspace/study/ant-design-pro/ant-design-pro-v2/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path:
        '/Users/chenzilong/workspace/study/ant-design-pro/ant-design-pro-v2',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
